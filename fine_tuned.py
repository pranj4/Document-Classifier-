...
config = DistilBertConfig.from_pretrained("distilbert-base-uncased", num_labels=3, dropout=0.2)
...
training_args = TrainingArguments(
    ...
    num_train_epochs=5,
    save_strategy="epoch",
    learning_rate=2e-5,  # 🔥 Reduce learning rate (Default is 5e-5, but 2e-5 works better for fine-tuning)
    weight_decay=0.01,
...
model.save_pretrained(r"C:\Users\91800\OneDrive\Desktop\NLP\model")
tokenizer.save_pretrained(r"C:\Users\91800\OneDrive\Desktop\NLP\model")
